    ...
    with open(sys.argv[2],"r") as arquivo:
        ...
        for leitura in arquivo:
            ...
            for simbolo in leitura:
                ret = le_simbolo(simbolo, automatos, estado_atual, automato_atual, pilha)
                cadeia_lida += simbolo
                #Rejeita cadeia
                if len(ret) == 0:
                    rejeitar = True
...
def le_simbolo(simbolo, automatos, estado_atual, automato_atual, pilha):
    # Transição normal
